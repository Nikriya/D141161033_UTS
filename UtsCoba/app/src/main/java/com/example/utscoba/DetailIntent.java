 ...
 */
public class DetailIntent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intent_detail);

        // Initialize the views.
        TextView materiTitle = findViewById(R.id.titleDetail);
        TextView materiIsi = findViewById(R.id.MateriDetail);
        ...
        materiIsi.setText(getIntent().getStringExtra("isi_materi"));
    }
}
